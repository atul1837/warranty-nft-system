API_URL = "https://eth-goerli.alchemyapi.io/v2/5p2Q3UIHAd4cpdcgoDLOX71xRhee3Tgp"
const PUBLIC_KEY = "0x9e6A054D09dA219c9c4F3cefCF4C9640763487b7"
const PRIVATE_KEY = "f68f478fee7dec62a51059284f0ac08ffe863e3da5dc5d04c47809c3752fd80f"
...
async function getSomething() {
    ...
    fcontract.methods.getcontractofowner().call().then(result => {
      console.log(result)
    }).catch(error=> {
        console.log(error)
    }) 
